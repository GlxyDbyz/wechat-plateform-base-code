...
<div class="am-g">
  <div class="am-u-lg-5 am-u-md-7 am-u-sm-centered">
      ...
      <input type="text" name="name" id="name" minlength="3" maxlength="20" title="请输入用户名（至少 3个字符）" class="am-form-field">
      </div>
      <br>
      <div>
      <label for="password">密码:</label>
      <input type="password" name="password" id="password" minlength="6"  maxlength="20" title="请输入密码（至少 6个字符）" class="am-form-field">
      </div>
      <br>
      <br/>
      <div class="am-cf">
